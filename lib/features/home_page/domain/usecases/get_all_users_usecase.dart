...
class GetAllUsersUseCase extends FirebaseBaseUseCase<void, FirebaseNoParameters> {
  final HomePageRepository homePageRepository;

  GetAllUsersUseCase(this.homePageRepository);

  @override
  Future<Either<FirebaseFailure, List<RulesModel>>> call(FirebaseNoParameters parameters) async {
    return await homePageRepository.getAllUsers();
  }
}