...
class DeleteReceiptUseCase extends FirebaseBaseUseCase {
  final HomePageRepository homePageRepository;

  DeleteReceiptUseCase(this.homePageRepository);

  @override
  Future<Either<FirebaseFailure, void>> call(parameters) async {
    return await homePageRepository.deleteReceipt(parameters);
  }
}