...
class GetZonesUseCase extends FirebaseBaseUseCase<void, FirebaseNoParameters> {
  final HomePageRepository homePageRepository;

  GetZonesUseCase(this.homePageRepository);

  @override
  Future<Either<FirebaseFailure, List<ZonesModel>>> call(FirebaseNoParameters parameters) async {
    return await homePageRepository.getZones();
  }
}