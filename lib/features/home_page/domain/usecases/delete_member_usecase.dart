...
class DeleteMemberUseCase extends FirebaseBaseUseCase {
  final HomePageRepository homePageRepository;

  DeleteMemberUseCase(this.homePageRepository);

  @override
  Future<Either<FirebaseFailure, void>> call(parameters) async {
    return await homePageRepository.deleteMember(parameters);
  }
}