...
class GetActiveCycleUseCase extends FirebaseBaseUseCase<void, FirebaseNoParameters> {
  final HomePageRepository homePageRepository;

  GetActiveCycleUseCase(this.homePageRepository);

  @override
  Future<Either<FirebaseFailure, List<CycleModel>>> call(FirebaseNoParameters parameters) async {
    return await homePageRepository.getActiveCycle();
  }
}